    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
                <a href="user_index.php" class="navbar-brand" rel="tooltip" title="Designed and Coded by YPS" data-placement="bottom" target="">
                    E-Shopping Mart
                </a>
            ...
            <div class="container">
                <nav>
                    <ul>
						...
						<li>Brought To You By <a href="#">E-Shopping Mart</a> | YPS</li>
                    </ul>
                </nav>
                <div class="copyright">
                    &copy;
